                                            ...
                                            @foreach(get_models('Category',['active'=>'1']) as $row)
                                                <li class="item-vertical  with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        @if($row->photo)
                                                            <img src="{{asset('storage/'.$row->photo->filename)}}" width="50px" height="50px" alt="icon">
                                                        @endif
                                ...
                                <div class="yt-content-slider" data-rtl="yes" data-autoplay="no"
                                    ...
                                    @foreach(get_models('Slider',['is_active'=>1]) as $row)
                                        ...
                                        <div class="yt-content-slide">
                                            <a href="#"><img src="{{asset('storage/'.$row->photo->filename)}}"
                                            ...
                                            <div class="item ">
                                                ...
                                                <div class="product-layout item-inner style1 ">
                                                    ...
                                                    <div class="item-info">
                                                        ...
                                                        <div class="content_price price">
                                                                <span class="price-new product-price">$80.00
                                                                </span>&nbsp;&nbsp;
                                                        ...
                                                        <div class="item-img-info">
                                                            <a href="product.html" target="_self"
                                                               title="Sausage cowbee ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/3.jpg')}}"
                                                                     alt="Sausage cowbee">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="item-image">
                                                        <div class="item-img-info">
                                                            <a href="#" target="_self" title="Chicken swinesha ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/4.jpg')}}"
                                                    ...
                                                    <div class="item-image">
                                                        <div class="item-img-info">
                                                            <a href="#" target="_self" title="Qeserunt shortloin ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/5.jpg')}}"
                                                    ...
                                                    <div class="item-image">
                                                        <div class="item-img-info">
                                                            <a href="#" target="_self" title="Consecte quichuck ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/6.jpg')}}"
                                                    ...
                                                    <div class="item-image">
                                                        <div class="item-img-info">
                                                            <a href="#" target="_self" title="Neatball bresaola ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/7.jpg')}}"
                                                    ...
                                                    <div class="item-image">
                                                        <div class="item-img-info">
                                                            <a href="#" target="_self" title="Yutculpa ullamco ">
                                                                <img src="{{asset('front/image/catalog/demo/product/80/8.jpg')}}"
            ...
            <div class="row content-main-w">
                                    ...
                                    <div class="item ">
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="product.html" target="_self"
                                                       title="Mandouille short "><img
                                                            src="{{asset('front/image/catalog/demo/product/80/5.jpg')}}"
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="product.html" target="_self"
                                                       title="Xancetta bresao "><img
                                                            src="{{asset('front/image/catalog/demo/product/80/3.jpg')}}"
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="product.html" target="_self"
                                                       title="Sausage cowbee "><img
                                                            src="{{asset('front/image/catalog/demo/product/80/4.jpg')}}"
                                            ...
                                            <div class="item-info">
                                                <div class="item-title">
                                                    <a href="product.html" target="_self"
                                                       title="Sausage cowbee">Sausage cowbee</a>
                                                </div>
                                                <div class="rating">
                                                        <span class="fa fa-stack"><i
                                                                class="fa fa-star fa-stack-2x"></i></span>
                    ...
                    <div class="module testimonials">
                        ...
                        <div class="slider-testimonials">
                            <div class="yt-content-slider contentslider" data-rtl="no" data-loop="yes"
                                 ...
                                 data-hoverpause="yes">
                                <div class="item">
                                    <div class="img"><img src="{{asset('front/image/catalog/demo/client/user-1.jpg')}}" alt="Image">
                                    </div>
                                ...
                                <div class="item">
                                    <div class="img"><img src="{{asset('front/image/catalog/demo/client/user-2.jpg')}}" alt="Image">
                                    </div>
                                ...
                                <div class="item">
                                    <div class="img"><img src="{{asset('front/image/catalog/demo/client/user-3.jpg')}}" alt="Image">
                                    </div>
                ...
                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                    ...
                    <div class="static-cates">
                        <ul>
                            <li>
                                <a href="#"><img src="{{asset('front/image/catalog/banners/cat1.jpg')}}" alt="image"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('front/image/catalog/banners/cat2.jpg')}}" alt="image"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('front/image/catalog/banners/cat3.jpg')}}" alt="image"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('front/image/catalog/banners/cat4.jpg')}}" alt="image"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('front/image/catalog/banners/cat5.jpg')}}" alt="image"></a>
                            </li>
                        </ul>
                    </div>
                                                ...
                                                <div class="item-available">
                                                    <div class="available">
                                                            <span class="color_width" data-title="77%"
                                                                  data-toggle='tooltip' style="width: 77%"></span>
                                                    </div>
                                                ...
                                                <div class="item-available">
                                                    <div class="available">
                                                            <span class="color_width" data-title="65%"
                                                                  data-toggle='tooltip' style="width: 65%"></span>
                                                    </div>
                                                ...
                                                <div class="item-available">
                                                    <div class="available">
                                                            <span class="color_width" data-title="67%"
                                                                  data-toggle='tooltip' style="width: 67%"></span>
                                                    </div>
                                                ...
                                                <div class="item-available">
                                                    <div class="available">
                                                            <span class="color_width" data-title="37%"
                                                                  data-toggle='tooltip' style="width: 37%"></span>
                                                    </div>
                                                ...
                                                <div class="item-available">
                                                    <div class="available">
                                                            <span class="color_width" data-title="38%"
                                                                  data-toggle='tooltip' style="width: 38%"></span>
                                                    </div>
                                ...
                                <div class="item-cat-image" style="min-height: 351px;">
                                    <a href="#" title="Technology" target="_self">
                                        <img class="categories-loadimage" alt="Technology"
                                             src="{{asset('front/image/catalog/demo/category/tab1.jpg')}}">
                                    </a>
                                </div>
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Lastrami bacon">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e1.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e10.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Exceeur sint occaecat">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e9.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e9.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Excepteur sint occ">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e5.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e6.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="PCenison meatloa">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e6.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/e2.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                ...
                                <div class="item-cat-image" style="min-height: 351px;">
                                    <a href="#" title="Funiture & Decor" target="_self">
                                        <img class="categories-loadimage" alt="Funiture & Decor"
                                             src="{{asset('front/image/catalog/demo/category/tab2.jpg')}}">
                                    </a>
                                </div>
                                <div class="slider category-slider-inner products-list yt-content-slider"
                                     data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4"
                                        ...
                                        <div class="item-inner product-layout transition product-grid">
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Sunt inculpa qui">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu1.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu10.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="caption hide-cont">
                                                        ...
                                                        <h4><a href="product.html" title="Pastrami bacon"
                                                               target="_self">Sunt inculpa qui</a></h4>
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Chicken swinesha">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu2.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu9.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Mapicola incidid">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu3.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu8.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                        ...
                                        <div class="item-inner product-layout transition product-grid">
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Dormd dea irure">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu4.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/fu7.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="caption hide-cont">
                                                        ...
                                                        <h4><a href="product.html" title="Pastrami bacon"
                                                               target="_self">Dormd dea irure </a></h4>
                                            ...
                                            <div class="product-item-container">
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="caption hide-cont">
                                                        ...
                                                        <h4><a href="product.html" title="Pastrami bacon"
                                                               target="_self">Mecepteur sint rew</a></h4>
                                            ...
                                            <div class="product-item-container">
                                                ...
                                                <div class="right-block">
                                                    ...
                                                    <div class="caption hide-cont">
                                                        ...
                                                        <h4><a href="product.html" title="Pastrami bacon"
                                                               target="_self">Sed ut perspicia</a></h4>
                                ...
                                <div class="item-cat-image" style="min-height: 351px;">
                                    <a href="#" title="Fashion & Accessories" target="_self">
                                        <img class="categories-loadimage" alt="Fashion & Accessories"
                                             src="{{asset('front/image/catalog/demo/category/tab3.jpg')}}">
                                    </a>
                                </div>
                                <div class="slider category-slider-inner products-list yt-content-slider"
                                     data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4"
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block left-b">
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Lastrami bacon">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/f1.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/f7.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                    ...
                                                    <div class="product-image-container second_img">
                                                        <a href="product.html" target="_self"
                                                           title="Mapicola incidid">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/f3.jpg')}}"
                                                                 class="img-1 img-responsive" alt="image1">
                                                            <img src="{{asset('front/image/catalog/demo/product/270/f8.jpg')}}"
                                                                 class="img-2 img-responsive" alt="image2">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                    ...
                    <div class="slider-brands col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="yt-content-slider contentslider" data-autoplay="no" data-delay="4"
                             data-speed="0.6" data-margin="0" data-items_column00="7" data-items_column0="7"

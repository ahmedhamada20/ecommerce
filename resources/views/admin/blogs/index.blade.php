        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <a href="{{route('blogs.create')}}" class="btn btn-success btn-sm">اضافه</a>
                        </div>
                    ...
                    <table id="example" class="table table-hover table-centered table-bordered ">
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{asset('storage/blogs/'.$row->image)}}" target="_blank">
                                        <img src="{{asset('storage/blogs/'.$row->image)}}" width="100px"
                                             height="100px" alt="">
                                    </a>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('blogs.show',$row->id)}}" class="btn btn-primary btn-sm">التعليقات</a>

...
{{--                                </a>--}}
                        ...
                        @include('admin.advertisement_banners.edit')
                        @include('admin.advertisement_banners.deleted')
                    @endforeach
                    </tbody>
                </table>
                {{$data->links()}}
    ...
    @include('admin.advertisement_banners.create')
...
@section('js')
    <script>
        function toggleStatus(id, currentStatus) {
            ...
            $.ajax({
                url: "{{ route('admin_updateAdvertisementBannersStatus') }}",
                method: "POST",
                headers: {

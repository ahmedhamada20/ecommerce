                ...
                <div class="table-responsive table-centered">
                    <table class="table mb-0">
                        ...
                        <tr>
                            ...
                            <td>29 April 2024</td>
                            <td>
                                <img src="{{asset('dash/assets/images/products/product-1(1).png')}}" alt="product-1(1)" class="img-fluid avatar-sm">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>25 April 2024</td>
                            <td>
                                <img src="{{asset('dash/assets/images/products/product-4.png')}}" alt="product-4" class="img-fluid avatar-sm">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>25 April 2024</td>
                            <td>
                                <img src="{{asset('dash/assets/images/products/product-5.png')}}" alt="product-5" class="img-fluid avatar-sm">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>21 April 2024</td>
                            <td>
                                <img src="{{asset('dash/assets/images/products/product-6.png')}}" alt="product-6" class="img-fluid avatar-sm">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>18 April 2024</td>
                            <td>
                                <img src="{{asset('dash/assets/images/products/product-1(2).png')}}" alt="product-1(2)" class="img-fluid avatar-sm">
                            </td>
                            <td>

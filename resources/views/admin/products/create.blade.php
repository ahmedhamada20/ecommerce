                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control custom-select" id="stock_status" name="stock_status"
                                        required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="width" name="width"
                                       placeholder="Width in cm" step="0.01">
                            </div>
                            <!-- Height -->
                            <div class="col-md-4 mb-3">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="meta_description_ar" name="meta_description_ar"
                                          rows="3" placeholder="Meta description for SEO in Arabic"></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="meta_description_en" name="meta_description_en"
                                          rows="3" placeholder="Meta description for SEO in English"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="form-section">
                        ...
                        <div id="taxes-container">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-5">
                                    <input type="number" class="form-control" name="tax_rates[]"
                                           placeholder="Tax Rate (%)" min="0" step="0.01">
                                </div>
                                <div class="col-md-2 text-end">
                    ...
                    <div class="form-section">
                        ...
                        <div id="coupon-container">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-5">
                                    <input type="number" class="form-control" name="coupon_number[]"
                                           placeholder="coupon" min="0">
                                </div>
                                <div class="col-md-2 text-end">

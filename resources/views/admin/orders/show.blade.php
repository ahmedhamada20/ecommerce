        ...
        <div class="row row-cards" bis_skin_checked="1">
            <div class="col-md-9" bis_skin_checked="1">
                <div class="card mb-3" bis_skin_checked="1">
                    <div class="card-body d-print-none" bis_skin_checked="1">
                        <div class="datagrid" bis_skin_checked="1">
                            <div class="datagrid-item" bis_skin_checked="1">
                                <div class="datagrid-title" style="display: flex; justify-content: space-between"
                                ...
                                <div class="datagrid-content" bis_skin_checked="1"><a href="#" target="_blank">
                            ...
                            <div class="datagrid-item" bis_skin_checked="1">
                                <div class="datagrid-title" bis_skin_checked="1">Status
                                </div>
                                <div class="datagrid-content" bis_skin_checked="1">
                            ...
                            <div class="datagrid-item" bis_skin_checked="1">
                                <div class="datagrid-title" bis_skin_checked="1">Last
                                    Update
                                </div>
                                <div class="datagrid-content" bis_skin_checked="1">{{$row->updated_at}}</div>
                            </div>

                            <div class="datagrid-item" bis_skin_checked="1">
                                <div class="datagrid-title" bis_skin_checked="1">Total
                                </div>
                                <div class="datagrid-content" bis_skin_checked="1">{{$row->total}}</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card" bis_skin_checked="1">
                    ...
                    <div class="card-body p-0" bis_skin_checked="1">
                        <div class="p-3" bis_skin_checked="1">
                            ...
                            <p class="mb-1">
                                <svg class="icon  svg-icon-ti-ti-inbox" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <hr>
                        <div class="hr my-1" bis_skin_checked="1"></div>

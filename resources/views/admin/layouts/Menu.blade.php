<!-- ========== App Menu Start ========== -->
<div class="main-nav" style="font-family: 'Cairo', sans-serif !important;">
    <!-- Sidebar Logo -->
    <div class="logo-box">
        <a href="index.html" class="logo-dark">
            <img src="{{asset('dash/assets/images/logo-sm.png')}}" class="logo-sm" alt="logo sm">
            <img src="{{asset('dash/assets/images/logo-dark.png')}}" class="logo-lg" alt="logo dark">
        </a>

        <a href="index.html" class="logo-light">
            <img src="{{asset('dash/assets/images/logo-sm.png')}}" class="logo-sm" alt="logo sm">
            <img src="{{asset('dash/assets/images/logo-light.png')}}" class="logo-lg" alt="logo light">
        </a>
    </div>
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.index')}}">
                    ...
                    <span class="nav-text"> الصفحه الرئسية </span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarSetting" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSetting">
                    ...
                    <span class="nav-text"> الاعدادات الرئسية </span>
                </a>
                <div class="collapse" id="sidebarSetting">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('admin.setting')}}">الاعدادات العامه</a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarProducts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('products.index')}}">جمبع المنتجات</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('products.create')}}">اضافه منتج جديد</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebargalleries" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebargalleries">
                                   <span class="nav-icon">
                ...
                <div class="collapse" id="sidebargalleries">
                    <ul class="nav sub-navbar-nav">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{route('galleries.index')}}">معرض الصور</a>
                            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarOrders">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('orders.index')}}">الطلبات</a>
                        </li>
